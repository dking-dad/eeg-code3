...
class ACRNN(pl.LightningModule):
    def __init__(self, n_classes, eeg_channels, cwa_hidden, cnn_in_channels, rnn_hidden, rnn_embed_dim, dropout = 0.0):
        ...
        self.linear_out = nn.Linear(rnn_hidden, n_classes)
        ...
        self.crossEntropyLoss = ARCNN_loss()
...
if __name__ == "__main__":
    ...
    train_set, val_set = dataset_prepare(segment_duration = 3, n_subjects = 26, load_all = True, single_subject = False, sampling_rate = 128)
