...
def visualise_egg(all_files):
    try:
        ...
        ten_twenty_montage = mne.channels.make_standard_montage('standard_1020')#按照标准画图
        channel_type="eeg"
...
def viusaliseemotions(k,model):
    try:
        ...
        ax1.axis('equal')  # Equal aspect ratio ensures that pie is drawn as a circle. 等宽高比确保饼图绘制为圆形。
